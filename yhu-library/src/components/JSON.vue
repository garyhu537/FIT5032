...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="(times, day) in weekdays" :key="day">
          {{ day }}: Open - {{ times.open }}, Close - {{ times.close }}
        </li>
        <li v-for="(times, day) in weekends" :key="day">
          {{ day }}: Open - {{ times.open }}, Close - {{ times.close }}
        </li>
      </ul>
...
const weekdays = {
  Monday: bookstores.openingHours.weekdays,
  Tuesday: bookstores.openingHours.weekdays,
  Wednesday: bookstores.openingHours.weekdays,
  Thursday: bookstores.openingHours.weekdays,
  Friday: bookstores.openingHours.weekdays,
};
